...
<template>
  <div :class="theme.isDark ? 'bg-gray-900' : 'bg-white'" class="flex h-screen transition-colors duration-500">
        ...
        <div :class="theme.isDark ? 'bg-gradient-to-b from-[#1A1A1A] via-[#2C2C54] to-[#3B3B3B]' : 'bg-white'" class="flex flex-col justify-center flex-1 py-12 w-1/5 transition-all duration-1100 ease-in-out">
          ...
          <div class="px-48 mt-6 flex flex-col items-center">
            ...
            <a @click.prevent="toggleAuthComponent" 
                :class="['mt-4 text-center w-auto cursor-pointer', theme.isDark ? 'text-white' : 'text-blue-500']" 
